...
generate_page_content <- function(page_title, year) {
  ...
  if (page_title=="Artist Analysis"){
    ...
    img1 <- readBin("../data/processed/wordcloud1.png", "raw", file.info("wordcloud1.png")$size)
    ...
    img2 <- readBin("../data/processed/wordcloud2.png", "raw", file.info("wordcloud2.png")$size)
    ...
    img <- readBin("../data/processed/wordcloud.png", "raw", file.info("wordcloud.png")$size)
