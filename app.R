...
generate_page_content <- function(page_title, year) {
  ...
  if (page_title=="Artist Analysis"){
    ...
    webshot("tmp1.html", "./data/processed/wordcloud1.png", delay = 3, vwidth = 900, vheight = 200)
    img1 <- readBin("./data/processed/wordcloud1.png", "raw", file.info("./data/processed/wordcloud1.png")$size)
    img1_base64 <- base64encode(img1)
    md_code1 <- paste0("![](data:image/png;base64,", img1_base64, ")")
    
    saveWidget(b, "tmp2.html", selfcontained = F)
    webshot("tmp2.html", "./data/processed/wordcloud2.png", delay = 3, vwidth = 900, vheight = 200)
    img2 <- readBin("./data/processed/wordcloud2.png", "raw", file.info("./data/processed/wordcloud2.png")$size)
    ...
    webshot("tmp.html", "./data/processed/wordcloud.png", delay = 3, vwidth = 900, vheight = 200)
    img <- readBin("./data/processed/wordcloud.png", "raw", file.info("./data/processed/wordcloud.png")$size)
